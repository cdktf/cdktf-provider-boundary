// https://registry.terraform.io/providers/hashicorp/boundary/1.1.11/docs/resources/managed_group_ldap
...
export class ManagedGroupLdap extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagedGroupLdap that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.11/docs/resources/managed_group_ldap#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.11/docs/resources/managed_group_ldap boundary_managed_group_ldap} Resource
  *
  * @param scope The scope in which to define this construct
