...
// https://registry.terraform.io/providers/hashicorp/boundary/1.1.10/docs
...
export class BoundaryProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing BoundaryProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.10/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.10/docs boundary} Resource
  *
  * @param scope The scope in which to define this construct
