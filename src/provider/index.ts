...
export interface BoundaryProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.12/docs#addr BoundaryProvider#addr}
  */
  readonly addr: string;
  /**
  * The auth method ID e.g. ampw_1234567890. If not set, the default auth method for the given scope ID will be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.12/docs#auth_method_id BoundaryProvider#auth_method_id}
  */
  readonly authMethodId?: string;
  /**
  * The auth method login name for password-style or ldap-style auth methods
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.12/docs#auth_method_login_name BoundaryProvider#auth_method_login_name}
  */
  readonly authMethodLoginName?: string;
  /**
  * The auth method password for password-style or ldap-style auth methods
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.12/docs#auth_method_password BoundaryProvider#auth_method_password}
  */
  readonly authMethodPassword?: string;
  /**
  * The auth method login name for password-style auth methods
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.12/docs#password_auth_method_login_name BoundaryProvider#password_auth_method_login_name}
  */
  readonly passwordAuthMethodLoginName?: string;
  /**
  * The auth method password for password-style auth methods
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.12/docs#password_auth_method_password BoundaryProvider#password_auth_method_password}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.12/docs#plugin_execution_dir BoundaryProvider#plugin_execution_dir}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.12/docs#recovery_kms_hcl BoundaryProvider#recovery_kms_hcl}
  */
  readonly recoveryKmsHcl?: string;
  /**
  * The scope ID for the default auth method.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.12/docs#scope_id BoundaryProvider#scope_id}
  */
  readonly scopeId?: string;
  /**
  * When set to true, does not validate the Boundary API endpoint certificate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.12/docs#tls_insecure BoundaryProvider#tls_insecure}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.12/docs#token BoundaryProvider#token}
  */
  readonly token?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.12/docs#alias BoundaryProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.12/docs boundary}
*/
export class BoundaryProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing BoundaryProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.12/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.12/docs boundary} Resource
  *
  * @param scope The scope in which to define this construct
