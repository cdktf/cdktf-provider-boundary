...
// https://registry.terraform.io/providers/hashicorp/boundary/1.3.0/docs/resources/scope_policy_attachment
...
export class ScopePolicyAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ScopePolicyAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/boundary/1.3.0/docs/resources/scope_policy_attachment#import import section} in the documentation of this resource for the id to use
