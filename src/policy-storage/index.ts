...
// https://registry.terraform.io/providers/hashicorp/boundary/1.4.0/docs/resources/policy_storage
...
export class PolicyStorage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyStorage that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/boundary/1.4.0/docs/resources/policy_storage#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/boundary/1.4.0/docs/resources/policy_storage boundary_policy_storage} Resource
  *
  * @param scope The scope in which to define this construct
