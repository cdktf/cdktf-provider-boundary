...
// https://registry.terraform.io/providers/hashicorp/boundary/1.1.14/docs/resources/host_catalog_static
...
export class HostCatalogStatic extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HostCatalogStatic that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.14/docs/resources/host_catalog_static#import import section} in the documentation of this resource for the id to use
