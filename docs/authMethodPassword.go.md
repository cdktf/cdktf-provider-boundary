...
Refer to the Terraform Registory for docs: [`boundary_auth_method_password`](https://registry.terraform.io/providers/hashicorp/boundary/1.1.5/docs/resources/auth_method_password).
...
```go
import "github.com/cdktf/cdktf-provider-boundary-go/boundary/v4/authmethodpassword"
