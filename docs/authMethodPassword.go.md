...
```go
import "github.com/cdktf/cdktf-provider-boundary-go/boundary/v9/authmethodpassword"
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.13/docs/resources/auth_method_password#import import section} in the documentation of this resource for the id to use
