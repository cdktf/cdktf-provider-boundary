...
```go
import "github.com/cdktf/cdktf-provider-boundary-go/boundary/v5/hoststatic"
...
| <code><a href="#@cdktf/provider-boundary.hostStatic.HostStaticConfig.property.hostCatalogId">HostCatalogId</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.8/docs/resources/host_static#host_catalog_id HostStatic#host_catalog_id}. |
