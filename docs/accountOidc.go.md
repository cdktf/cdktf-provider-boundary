...
Refer to the Terraform Registory for docs: [`boundary_account_oidc`](https://registry.terraform.io/providers/hashicorp/boundary/1.1.9/docs/resources/account_oidc).
...
```go
import "github.com/cdktf/cdktf-provider-boundary-go/boundary/v6/accountoidc"
