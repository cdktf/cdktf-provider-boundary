...
```go
import "github.com/cdktf/cdktf-provider-boundary-go/boundary/v5/host"
...
| <code><a href="#@cdktf/provider-boundary.host.HostConfig.property.hostCatalogId">HostCatalogId</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.8/docs/resources/host#host_catalog_id Host#host_catalog_id}. |
