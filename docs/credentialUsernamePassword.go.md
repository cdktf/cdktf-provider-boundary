...
Refer to the Terraform Registory for docs: [`boundary_credential_username_password`](https://registry.terraform.io/providers/hashicorp/boundary/1.1.9/docs/resources/credential_username_password).
...
```go
import "github.com/cdktf/cdktf-provider-boundary-go/boundary/v6/credentialusernamepassword"
