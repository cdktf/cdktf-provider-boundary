...
Refer to the Terraform Registory for docs: [`boundary_credential_store_vault`](https://registry.terraform.io/providers/hashicorp/boundary/1.1.9/docs/resources/credential_store_vault).
...
```go
import "github.com/cdktf/cdktf-provider-boundary-go/boundary/v7/credentialstorevault"
