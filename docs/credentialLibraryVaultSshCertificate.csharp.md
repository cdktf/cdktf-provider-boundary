...
```csharp
private void ResetAdditionalValidPrincipals()
```
...
CredentialLibraryVaultSshCertificate.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
```csharp
public string[] AdditionalValidPrincipalsInput { get; }
```
...
```csharp
public string[] AdditionalValidPrincipals { get; }
```
...
new CredentialLibraryVaultSshCertificateConfig {
    ...
    string Path,
    string Username,
    string[] AdditionalValidPrincipals = null,
...
```csharp
public string[] AdditionalValidPrincipals { get; set; }
```
